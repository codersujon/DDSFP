        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="needs-validation" novalidate="" method="POST" action="" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="validationCustom01" placeholder="Enter book title" required="" name="title">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="validationCustom01" placeholder="Enter author name" required="" name="author">
                                <div class="valid-feedback">
                                    Looks good!
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                         ...
                         <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control" id="validationCustom01" required="" name="upload_file" accept=".pdf">
                                <div class="valid-feedback">
                                    Looks good!
                                </div>
                            </div>
                    ...
                    <div>
                        <button class="btn btn-primary" type="submit" name="add_book">Submit</button>
                    </div>
                </form>
